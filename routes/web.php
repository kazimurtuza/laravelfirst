...
Route::get('viewstudent/{id}','studentcontroller@viewstu');
Route::get('addstudent','studentcontroller@addstudents')->name('student');
Route::post('storestudent','studentcontroller@storestudent')->name('storestudent');
Route::get('viewallstudent','studentcontroller@viewstudent')->name('viewstudent');
 Route::get('viewidwisestu','studentcontroller@viewstu')->name('allstu');
 Route::post('stuupdate/{id}','studentcontroller@stuupdate');
 Route::get('deleteidwisestu/{id}','studentcontroller@deleteidwisestu');
 Route::get('editstu/{id}','studentcontroller@editstu');
